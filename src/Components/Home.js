            ...
            <div className="col-lg-8 col-md-10 mx-auto">
              <div className="post-preview">
                ...
                <p className="post-meta">
                  Posted by
                  <a href="#">Start Bootstrap</a> on September 24, 2017
                </p>
              </div>
              <hr />
              <div className="post-preview">
                ...
                <p className="post-meta">
                  Posted by
                  <a href="#">Start Bootstrap</a> on September 18, 2017
                </p>
              </div>
              <hr />
              <div className="post-preview">
                ...
                <p className="post-meta">
                  Posted by
                  <a href="#">Start Bootstrap</a> on August 24, 2017
                </p>
              </div>
              <hr />
              <div className="post-preview">
                ...
                <p className="post-meta">
                  Posted by
                  <a href="#">Start Bootstrap</a> on July 8, 2017
                </p>
              </div>
              <hr />
